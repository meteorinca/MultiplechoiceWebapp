...
const App = () => {
  ...
  const [workspaceView, setWorkspaceView] = useState<'exams' | 'whiteboard'>('exams');
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <header className="flex flex-col gap-4 rounded-[32px] bg-white/70 px-6 py-6 shadow-card backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-center sm:gap-4">
            ...
            <div className="flex items-center gap-2 rounded-2xl border border-cream-100 bg-cream-50 px-2 py-1">
              <button
                type="button"
